    ...
    async ({ event }) => {
        ...
        for (const user of users) {
            ...
            <div style="padding: 24px; color: #333;">
                ...
                <a href="https://quickshow-ecru.vercel.app/movies/${movieId}" style="background-color: #F84565; color: white; padding: 12px 20px; text-decoration: none; border-radius: 6px; font-weight: bold;">🎟️ Book Your Tickets</a>
                </div>
            </div>
